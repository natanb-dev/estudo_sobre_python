...
while (RESP==1):
  ...
  while (RESP1<=2):
    ...
    MaiorNota1 = MaiorNota2 = MaiorNota3 = MEDIA = 0
    ...
    ESCREVER.writelines('\nRA: '+str(RA))  
    ESCREVER.writelines('\n1° Maior Nota Presencial: {:.2f}'.format(MaiorNota1))
    ESCREVER.writelines('\n2° Maior Nota Presencial: {:.2f}'.format(MaiorNota2))
